...
SitePrism is built and tested to work on Ruby 2.5 - 3.0. Ruby 2.5 (Now EOL), is supported but
...
such as 3.0, if for any other reason, to get a noticeable speed boost!
